...
function injectScripts() {
    ...
    $.get(chrome.extension.getURL("/lib/pixi.min.js"),
        function(data) {
            text = "" + data;
            script.appendChild(document.createTextNode(text));
            $.get(chrome.extension.getURL("/lib/jquery.js"),
                function(data) {
                    text = "" + data;
                    script.appendChild(document.createTextNode(text));
                    $.get(chrome.extension.getURL("/lib/tuna-min.js"),
                        function(data) {
                            text = "" + data;
                            script.appendChild(document.createTextNode(text));
                            $.get(chrome.extension.getURL("/src/sliders.js"),
                                function(data) {
                                    text = "" + data;
                                    script.appendChild(document.createTextNode(text));
